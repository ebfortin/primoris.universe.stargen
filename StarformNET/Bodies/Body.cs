...
namespace Primoris.Universe.Stargen.Bodies
{
	...
	[Serializable]
	public abstract class Body : IEquatable<Body>
	{
		private static readonly IBodyPhysics DefaultPhysics = new BodyPhysics();
		...
		/// </summary>
		public double MassSM { get; protected set; }
		...
		public IEnumerable<Body> Satellites { get; protected set; }
		...
		protected abstract void Generate(BodySeed seed, int planetNo, Star sun, bool useRandomTilt, string planetID, SystemGenerationOptions genOptions);

		protected abstract IEnumerable<Body> GenerateSatellites(BodySeed seed, Star star, Body parentBody, bool useRandomTilt, SystemGenerationOptions genOptions);
