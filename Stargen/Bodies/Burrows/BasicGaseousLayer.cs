...
{
    protected BasicGaseousLayer(LayerStack stack, Mass mass, Length thickness)
        : base(stack, mass, thickness) 
    {
        // TODO: Add surface pressure setting.
    }
    ...
    public BasicGaseousLayer(LayerStack stack, Length thickness, Pressure surfPres)
        : base(stack, thickness, surfPres)
    {
    }

    public BasicGaseousLayer(LayerStack stack, Length thickness, IEnumerable<(Chemical, Ratio)> composition, Pressure surfPres)
        : base(stack, thickness, composition, surfPres)
    {
        Breathability = CalculateBreathability();
    }

    public BasicGaseousLayer(LayerStack stack, Length thickness, IEnumerable<Chemical> availableChems)
        : base(stack, thickness)
    {
        Generate(availableChems, stack.GetLayersBelow(this));
    }
    ...
    void Generate(IEnumerable<Chemical> availableChems, IEnumerable<Layer> curLayers)
    {
    ...
    static void CheckForSpecialRules(out double abund, out double react, double pressure, SatelliteBody planet, Chemical gas)
    {
